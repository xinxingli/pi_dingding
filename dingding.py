...
class DingDing(object):
    ...
    def _post(self, data):
        ...
        req = urllib2.Request(self.url, data=data.encode('utf-8'), headers=self.headers)
        _context = ssl._create_unverified_context()
        response = urllib2.urlopen(req, context=_context)
...
if __name__ == "__main__":
   ...
   # 下面的DingDing里面的参数为ding_token，在创建自定义机器人的时候就能获得
    ding = DingDing("627df77b61d5f6fbf080146287249d62ba07d5d8ba0fd4c8f49d8ef18d81799d")
    ding.send_markdown("树莓派状态监控",'### 树莓派状态监控 \n> ###### **time:** %s  \n> ###### **ip:** %s \n> ###### **cpu temp:** %2.2f ℃' % (localtime,ip,cpu))
    print "消息推送成功！"
